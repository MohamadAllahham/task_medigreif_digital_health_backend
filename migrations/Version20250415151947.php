 ...
 */
final class Version20250415151947 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE mood_entry (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, mood_type VARCHAR(30) NOT NULL, timestamp DATETIME NOT NULL, note CLOB NOT NULL)
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TEMPORARY TABLE __temp__mood_entry AS SELECT id, mood_type, timestamp, note, user_id FROM mood_entry
        SQL);
        $this->addSql(<<<'SQL'
            DROP TABLE mood_entry
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            INSERT INTO mood_entry (id, mood_type, timestamp, note, user_id) SELECT id, mood_type, timestamp, note, user_id FROM __temp__mood_entry
        SQL);
        $this->addSql(<<<'SQL'
            DROP TABLE __temp__mood_entry
        SQL);
